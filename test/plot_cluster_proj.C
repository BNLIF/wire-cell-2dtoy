...
void plot_cluster_proj(TString runno="5195_0_23", int cluster_id=33, int min_time = 0, int max_time = 9600, int min_u1_ch = 0, int max_u1_ch = 2399, int min_v1_ch = 2400, int max_v1_ch = 4799, int min_w1_ch = 4800, int max_w1_ch = 8256){
  TString filename = "match_" + runno + ".root";
