...
int main(int argc, char* argv[])
{
  ...
  //BUILD CHIRP MAPS///////////////////////////////////////
  WireCell::ChirpMap uplane_map;
  WireCell::ChirpMap vplane_map;
  WireCell::ChirpMap wplane_map;
  ...
  for (int i=start_num;i!=end_num+1;i++){
    ...
    //toytiling[i] = new WireCell2dToy::ToyTiling(slice,gds,0.15,0.2,0.1,threshold_ug,threshold_vg, threshold_wg, 0, 0, 0);
