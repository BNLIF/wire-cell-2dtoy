...
int main(int argc, char* argv[])
{
  ...
  for (int i=start_num;i!=end_num+1;i++){
    ...
    std::cout << lowmemtiling[i]->get_cell_wires_map().size()<< " " << lowmemtiling[i]->get_all_good_wires().size() << " " << lowmemtiling[i]->get_all_bad_wires().size() << " " << lowmemtiling[i]->get_all_cell_centers().size() << " " << lowmemtiling[i]->get_wire_cells_map().size() << std::endl;
    //std::cout << lowmemtiling[i]->get_cell_wires_map().size() << " " << lowmemtiling[i]->get_wire_cells_map().size() << std::endl;
    ...
    // display.draw_points(lowmemtiling[i]->get_all_cell_centers(),"*same");
