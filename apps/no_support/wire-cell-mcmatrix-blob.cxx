...
int main(int argc, char* argv[])
{
  ...
  if (start_num != end_num){
    ...
    if (toymatrix[end_num]->Get_Solve_Flag()==0){
      ...
      toymatrix_markov[end_num] = new WireCell2dToy::ToyMatrixMarkov(toymatrix[end_num-1],toymatrix[end_num],0,mergetiling[end_num-1],mergetiling[end_num],0,&allmcell);
    ...
    if (toymatrix[start_num]->Get_Solve_Flag()==0){
      ...
      toymatrix_markov[start_num] = new WireCell2dToy::ToyMatrixMarkov(0,toymatrix[start_num],toymatrix[start_num+1],0,mergetiling[start_num],mergetiling[start_num+1],&allmcell);
