...
// void WireCell2dToy::Clustering_prolong(WireCell::PR3DClusterSelection& live_clusters, std::map<PR3DCluster*,double>& cluster_length_map, double length_cut){
...
bool WireCell2dToy::Clustering_2nd_round(WireCell::PR3DCluster *cluster1, WireCell::PR3DCluster *cluster2, double length_1, double length_2, double length_cut){
  ...
  if (dis < length_cut || (dis < 80*units::cm && length_1>25*units::cm && length_2>25*units::cm)){
	...
	// if (cluster1->get_cluster_id()==112 || cluster2->get_cluster_id()==112)
	...
	if ((3.1415926 - dir1.Angle(dir2))/3.1415926*180 < 30)
      ...
      if (fabs(angle1-3.1415926/2.)<5/180.*3.1415926 && fabs(angle4-3.1415926/2.)<5/180.*3.1415926){
	flag_para = true;
