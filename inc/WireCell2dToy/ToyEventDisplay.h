...
namespace WireCell2dToy {
	...
	virtual int draw_merged_wires(WireCell::GeomWireSelection wires, TString option, int color = 2);

	virtual int draw_points(WireCell::PointVector pcells, TString option, int color = 2);
