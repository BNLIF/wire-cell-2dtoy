...
namespace WCP2dToy{
  ...
  WCP::FlashTPCBundleSelection tpc_light_match(double eventTime, int time_offset, int nrebin, WCP::Photon_Library *pl, std::map<WCP::PR3DCluster*,std::vector<std::pair<WCP::PR3DCluster*,double>>>& group_clusters, WCP::OpflashSelection& flashes, Int_t runno = 0,  bool flag_data = true, bool flag_add_light_yield_err = false, bool flag_timestamp = false);
